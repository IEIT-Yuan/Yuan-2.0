...
import time
import sys
sys.path.append('/temp_data/zhaoxd/tensorrt-llm-0.6/examples/')
import argparse
import csv
...
from tensorrt_llm.runtime import PYTHON_BINDINGS, ModelRunner, GenerationSession
...
def parse_arguments(args=None):
    ...
    parser.add_argument('--engine_dir', type=str, default='./yuan_kv_cache')
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        #default=["Born in north-east France, Soyer trained as a Born in north-east France, Soyer trained as a Born in north-east France, Soyer trained as a Born in north-east France, Soyer trained as a Born in north-east France, Soyer trained as a Born in north-east France, Soyer trained as a Born in north-east France, Soyer trained as a Born in north-east France, Soyer trained as a"])
