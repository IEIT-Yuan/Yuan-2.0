...
#from vllm.model_executor.layers.fused_layer_norm import FusedRMSNorm
...
class LocalizedFiltering(torch.nn.Module):
    ...
    def __init__(self, hidden_size):
        ...
        self.output_layernorm = FusedRMSNorm(self.embed_dim)
...
class YuanAttention(nn.Module):
    ...
    def forward(
        ...
        import pdb
        if hidden_states.shape == torch.Size([1, 7, 2048]):
            pdb.set_trace()
        ...
        cos, sin = self.rotary_emb(v, seq_len=8192)
